      ...
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <p className="text-lg text-warm-200 max-w-3xl mx-auto leading-relaxed">
            Reserve your spot at Raag Music Cafe for an unforgettable evening of
            music, food, and culture. Book your table now and join our vibrant
            community!
          </p>
        </motion.div>
          ...
          >
            ...
            <div className="space-y-6 mb-8">
              {contactInfo.map((info, index) => (
                ...
                >
                  <div className="text-accent-400 mt-1">{info.icon}</div>
                  <div>
            ...
            >
              <iframe
                src="https://www.google.com/maps?q=RAAG+MUSIC+CAFE,+Shankar+Nagar,+Raipur,+Chhattisgarh&output=embed"
                width="100%"
                height="300"
                style={{ border: 0 }}
                allowFullScreen
          ...
          >
            ...
            <div className="mt-8 p-4 bg-accent-50 rounded-lg">
              <p className="text-sm text-warm-600 text-center">
                <strong>Quick Response:</strong> We'll confirm your booking
